...
{% include textbook-graph-it.html topic="markets" subtopic="demand" graph="graph-demand" %}

Here is another:

{% include textbook-graph-it.html topic="competition" subtopic="demand" graph="many_identical_consumers" %}
